...
from .utils import CLIENT_0, IMAGE_0, IMAGE_1,  PASSWORD_0,  SUPERUSER_0, ADMIN_0,  f_login_user, f_logout_user, f_create_image, f_delete_file
...
def test_by_admin(test_client):
    ...
    f_delete_file(names=[IMAGE_0, IMAGE_1])
